...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "conference_membership", :force => true do |t|
  ...
  add_index "player_games", ["team_game_id", "type"], :name => "player_games_type_team_games_id"
  ...
  create_table "roster", :force => true do |t|
    t.integer "team_id",   :null => false
  ...
  create_table "team_diff_ranks", :force => true do |t|
    t.integer "team_id"
    t.integer "fgm"
    t.integer "fga"
    t.integer "fgp"
  ...
  create_table "team_foe_ranks", :force => true do |t|
    t.integer "team_id"
    t.integer "fgm"
    t.integer "fga"
    t.integer "fgp"
  ...
  create_table "team_ranks", :force => true do |t|
    t.integer "team_id"
    t.integer "fgm"
    t.integer "fga"
    t.integer "fgp"
