...
def add_averages(games, team, foe=false)
  ...
  games.each do |game|
    ...
    average_klass.create(:team_id => team.id, :games => count,
                         ...
                         :total_rebound => sum_total_rebound.to_f/count,
                         :assist => sum_assist.to_f/count,
                         :steal  => sum_steal.to_f/count,
                         :block  => sum_block.to_f/count,
                         :turnover => sum_turnover.to_f/count,
                         :foul => sum_foul.to_f/count,
                         :half1_point => 0,
                         :half2_point => 0,
                         :total_point => sum_total_point.to_f/count,
                         :total_to => sum_turnover,
                         :ppp => sum_ppp/count,
                         :get_ft => sum_ftm.to_f/sum_fga,
                         :orp => sum_orp/count,
                         :to_rate => sum_turnover.to_f/sum_poss,
                         :poss => sum_poss/count,
