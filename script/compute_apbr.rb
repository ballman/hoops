...
games = Game.find(:all,
:include => :team_games,
:conditions => ['played_on > \'2009-11-1\' and team_games.type = \'MasterTeamGame\' and (home_team_id = 89 or away_team_id = 89)'])
...
#  games = Game.find(:all,
#                     :include => :team_games,
#                     :conditions => ['played_on > \'2009-11-1\' and team_games.type = \'MasterTeamGame\' and (home_team_id = ? or visit_team_id = ?)', team.id, team.id])
